...
#        self.history_log.to_csv(file_path + self.logname, mode='w')
    ...
    def send(self):
        ...
        if text == "help":
            ...
            msg = ("<b>h</b>: recall previously typed messages.<br>\n"
            ...
            if i>0:
                ...
                his_text = "TPS_BlueMagpie has not received operational command yet." 
...
class SpectrumWidget(QWidget):
    ...
    def scan_loop(self, det, sptext):
        ...
        for i in range(n+1):
            ...
            QtGui.QApplication.processEvents()
            cmd_global.sysReturn('i = ' +str(i)+'   '+scan_param+' = '+ str(scan_x[i])+ ',  '+str(scan_data))
